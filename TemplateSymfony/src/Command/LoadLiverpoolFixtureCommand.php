...
#[AsCommand(
    name: 'app:load-liverpool',
    description: 'Charge l\'effectif Liverpool FC 2025/2026 pour un coach donné',
)]
class LoadLiverpoolFixtureCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $this->baseTeamImporter->syncLiverpool($coach);

        $io->success(sprintf(
            '%s Liverpool FC 2025/2026 pour %s : %d joueur(s) créé(s), %d mis à jour, %d supprimé(s)%s.',
